...
Built on **Rust**, on top of **Cloudflare's Pingora engine**, Aralez delivers performance, security and scalability — right out of the box.
...
<div class="feature-grid">
  ...
  <div class="feature-card">
    <div class="icon">💾</div>
    <h3>HTTP Caching</h3>
    <p>Local in-memory LRU, TTL behavior, <code>Cache-Control</code> handling website accelerator.</p>
  </div>
</div>
